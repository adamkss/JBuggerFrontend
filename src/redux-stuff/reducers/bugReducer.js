...
const bugReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case WAITING_FOR_GENERAL_UPDATE: {
            return {
                ...state,
                waitingForGeneralUpdate: true
            }
        }
        case FINISHED_WAITING_FOR_GENERAL_UPDATE: {
            return {
                ...state,
                waitingForGeneralUpdate: false
            }
        }
        case CLEAR_BUGS_DATA: {
            return initialState;
        }
        default:
            return state;
