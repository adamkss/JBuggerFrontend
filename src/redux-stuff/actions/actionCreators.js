...
export const clearBugsData = () => {
    return {
        type: CLEAR_BUGS_DATA
    }
}
...
export const waitingForGeneralUpdate = () => {
    return {
        type: WAITING_FOR_GENERAL_UPDATE
    }
}
